...
const NewRouter = { template: '<div>添加新的路由记录对象: "{{ $route.params }}"</div>' }
  ...
  template: `
    <div id="app">
      ...
      <ul>
        ...
        <li><router-link to="/newRouter">/newRouter</router-link></li>
	  ...
	  <button @click="addRouterRecord">添加新的路由记录对象</button>
  ...
  methods: {
	...
	addRouterRecord() {
		this.$router.addRoute({ 
			path: '/newRouter', component: NewRouter 
		})
		// setTimeout(() => {
		// 	console.log("markChen>>>> 添加路由后跳转到新的路由对象");
